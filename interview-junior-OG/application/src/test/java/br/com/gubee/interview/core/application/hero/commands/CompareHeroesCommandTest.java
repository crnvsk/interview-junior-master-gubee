...
class CompareHeroesCommandTest {
        ...
        void shouldCompareHeroesSuccessfully() {
                ...
                FindPowerStatsByIdQueryStub findPowerStatsByIdQueryStub = new FindPowerStatsByIdQueryStub(
                                powerStatsRepositoryStub);

                CompareHeroesCommand compareHeroesCommand = new CompareHeroesCommand(heroRepositoryStub,
                                findPowerStatsByIdQueryStub);
